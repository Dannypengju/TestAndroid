package com.example.testandroid.sliding;
...
import com.example.testandroid.sliding.SlidingMenu.OnClosedListener;
import com.example.testandroid.sliding.SlidingMenu.OnOpenedListener;
...
//		((SlidingMenu)getParent()).manageLayers(getPercentOpen());
	...
	/**
	 * �˷����ڻ���ʱ������������action upʱ������ʱ���뵽��һ��page�� page 0,1,2
	 * @param pageOffset
	 * @param velocity
	 * @param deltaX
	 * @return
	...
	private int determineTargetPage(float pageOffset, int velocity, int deltaX) {
		...
		Log.d(TAG, "determineTargetPage: targetPage is:" + targetPage);
		return targetPage;
	}
